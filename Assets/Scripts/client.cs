...
public class client : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sname = new float[] { currentPlayers[0].transform.position.x, currentPlayers[1].transform.position.x, currentPlayers[2].transform.position.x, currentPlayers[3].transform.position.x };
        bname = new byte[sname.Length * 4];
    }
    ...
    void Update()
    {
        ...
        //sname = System.Text.Encoding.ASCII.GetString(Convert.ToByte(currentPlayers[0].text)); //Testing
        sname = new float[] { currentPlayers[0].transform.position.x, currentPlayers[1].transform.position.x, currentPlayers[2].transform.position.x, currentPlayers[3].transform.position.x };
